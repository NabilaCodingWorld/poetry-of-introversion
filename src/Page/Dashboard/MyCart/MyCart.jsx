...
const img_hosting_token1 = import.meta.env. VITE_Image_Upload_Token1;
...
const MyCart = () => {
    ...
    const img_hosting_url1=`https://api.imgbb.com/1/upload?key=${img_hosting_token1}`
    ...
    const onSubmit = data => {
        ...
        .then(imgResponse => {
            ...
            if(imgResponse.success){
                ...
                console.log(newItem);
                axiosSecure.post('/dailyBlog', newItem)
                .then(data =>{
